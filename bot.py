...
def get_houses_menu():
    ...
    # Глэмпинги
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Зубр» (Зима/Лето)", callback_data="glamp_zubr"))
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Кабан» (Зима/Лето)", callback_data="glamp_kaban"))
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Олень» (Летний)", callback_data="glamp_olen"))
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Барсук» (Летний)", callback_data="glamp_barsuk"))
...
HOUSES_INFO = {
    "house_standart": {
        ...
        "desc": (
            "🌲 <b>Дом «Уютный стандарт»</b> (36 кв.м)\n"
            "Настоящий деревянный дом из бруса с панорамным видом на лес, атмосферой гармонии и тепла.\n\n"
            "✨ <b>Главная изюминка:</b> застеклённая терраса с камином и пледами для умиротворённых вечеров в любое время года.\n\n"
            "🛋 <b>Комфорт и оснащение:</b>\n"
            "• Камин, обогреватель, вентилятор, Wi-Fi, ТВ\n"
            "• Рабочее место, утюг, детская кроватка\n"
            "• Светонепроницаемые шторы, москитная сетка\n\n"
            "🍳 <b>Кухня:</b>\n"
            "Микроволновка, холодильник, чайник, чай/кофе, посуда и обеденный стол.\n\n"
            "🚿 <b>Ванная комната:</b>\n"
            "Санузел, душ, стиральная машина, фен, тапочки, косметика, бассейн.\n\n"
            "🌿 <b>Вид:</b> на сад, лес и внутренний двор.\n\n"
            "Бронируйте уютный отдых на природе прямо сейчас! 👇"
        )
    },
    "house_standart_plus": {
        ...
        "desc": (
            "🌲 <b>Дом «Уютный стандарт плюс»</b> (24 кв.м)\n"
            "Тёплый деревянный дом из бруса для тех, кто ценит гармонию с природой и комфорт.\n\n"
            "✨ <b>Главная изюминка:</b> застеклённая терраса с камином и мягкими пледами для душевных вечеров в любое время года.\n\n"
            "🛋 <b>Комфорт и климат:</b>\n"
            "• Кондиционер, климат-контроль, обогреватель\n"
            "• Москитная сетка, светонепроницаемые шторы\n"
            "• ТВ с кабельными каналами, скоростной Wi-Fi\n\n"
            "🍳 <b>Кухня:</b>\n"
            "Микроволновка, холодильник, чайник, чай/кофе, посуда, приборы и стол.\n\n"
            "🚿 <b>Ванная комната:</b>\n"
            "Санузел, душ, стиральная машина, фен, халаты, тапочки, косметика, бассейн.\n\n"
            "🌿 <b>Вид:</b> живописный пейзаж на сад и вековой лес.\n\n"
            "Бронируйте незабываемый отдых прямо сейчас! 👇"
        )
    },
    "house_semeiniy": {
        ...
        "desc": (
            "🌲 <b>Просторный семейный дом</b> (54 кв.м)\n"
            "Идеально для отдыха большой семьей или компанией. Спальни с ортопедическими матрацами.\n\n"
            "✨ <b>Главные особенности:</b>\n"
            "• 🔥 Кухня-гостиная с камином, спутниковым ТВ и травяным чаем\n"
            "• 🪵 Меблированная терраса с пледами и подушками\n"
            "• 🍖 Зона барбекю: казан, решетка, шампуры, дрова и угли\n\n"
            "🛋 <b>Комфорт и оснащение:</b>\n"
            "• Обогреватель, вентилятор, утюг, детская кроватка\n"
            "• Москитные сетки, Wi-Fi, спутниковое ТВ\n\n"
            "🍳 <b>Кухня:</b>\n"
            "Духовка, микроволновка, холодильник, чайник, посуда и большой стол.\n\n"
            "🚿 <b>Ванная комната:</b>\n"
            "Санузел, душ, стиральная машина, фен, тапочки, косметика, бассейн.\n\n"
            "🌿 <b>Вид:</b> на внутренний двор, сад и вековой лес.\n\n"
            "Бронируйте незабываемый отдых прямо сейчас! 👇"
        )
    },
    "house_ohotnichiy": {
        ...
        "desc": (
            "🌲 <b>Охотничий Люкс</b> (86 кв.м, до 10 человек)\n"
            "Просторный дом в окружении векового леса — тишина, покой и чистейший воздух.\n\n"
            "✨ <b>Особенности:</b>\n"
            "• 🛏 4 спальни с комфортными спальными местами\n"
            "• 🔥 Гостиная с камином для атмосферных вечеров\n"
            "• 🌳 Терраса и беседка с зоной барбекю\n"
            "• 🏊‍♂️ Бассейн в теплый сезон, качели во дворе\n\n"
            "🛋 <b>Удобства и климат:</b>\n"
            "• Кондиционер, климат-контроль, обогреватель, вентилятор\n"
            "• Стиральная машина, утюг, детская кроватка, гардероб\n"
            "• Wi-Fi, спутниковое ТВ, звуковая система\n\n"
            "🍳 <b>Кухня:</b>\n"
            "Холодильник, духовка, СВЧ, кофемашина, чайник, посуда, большой стол.\n\n"
            "🚿 <b>Ванная:</b> санузел, душ, фен, тапочки, косметика.\n"
            "🌿 <b>Вид:</b> на сад, двор и вековой лес.\n\n"
    ...
    "house_komfort": {
        ...
        "desc": (
            "🌟 <b>Дом «Комфорт Плюс»</b> (36 кв.м, 2–4 гостя)\n"
            "Роскошная резиденция, сочетающая современные удобства и элегантный дизайн.\n\n"
            "✨ <b>Особенности:</b>\n"
            "• 🚪 Отдельный вход для полной приватности\n"
            "• 🪟 Панорамные окна в пол с потрясающим светом\n"
            "• ☕️ Терраса и балкон для утреннего кофе и вечерних посиделок\n"
            "• 🔥 Каминная зона и светлая гостиная\n\n"
            "🛋 <b>Оснащение:</b>\n"
            "• Кондиционер, климат-контроль, обогреватель\n"
            "• Рабочее место, утюг, детская кроватка, Wi-Fi, ТВ\n\n"
            "🍳 <b>Кухня:</b>\n"
            "СВЧ, духовка, тостер, чайник, чай/кофе, посуда и обеденный стол.\n\n"
            "🚿 <b>Ванная и сервис:</b>\n"
            "Санузел, душевая кабина, стиральная машина, фен, тапочки, косметика, бассейн, хранение багажа.\n"
            "🌿 <b>Вид:</b> на сад, двор и лес.\n\n"
            "Бронируйте идеальный отдых прямо сейчас! 👇"
        )
    },
    "glamp_zubr": {
        "title": "⛺ Глэмпинг «Зубр»",
        ...
        "desc": (
            "🌲 <b>Глэмпинг «Зубр»</b> (24 кв.м) — <i>Всесезонный (Зима / Лето)</i>\n"
            "Уютный дом в сердце векового леса для комфортного отдыха в любое время года. Панорамное окно с видом на лесную чащу прямо у кровати.\n\n"
            "✨ <b>Особенности и активности:</b>\n"
            "• 🏕 Мини-кухня, раскладной диван, круглогодичное проживание\n"
            "• 🍖 Зона барбекю с мангалом\n"
            "• ⚽️ Площадка, батут, волейбол, футбол, настольный теннис\n"
            "• 🦌 Экотропы, веломаршруты, вольеры с животными (зубры, олени)\n\n"
            "🛋 <b>Климат и удобства:</b>\n"
            "• Кондиционер, система климат-контроля, обогреватель\n"
            "• Москитные сетки, рабочее место, утюг, гардероб, детская кроватка\n\n"
            "🍳 <b>Мини-кухня:</b>\n"
            "СВЧ, холодильник, чайник, чай/кофе, посуда и приборы.\n\n"
            "🚿 <b>Ванная:</b> санузел, душ, фен, тапочки, косметика, бассейн.\n"
            "🌿 <b>Вид:</b> на сад, двор и вековой лес.\n\n"
            "Оживите связь с природой — бронируйте прямо сейчас! 👇"
        )
    },
    "glamp_kaban": {
        ...
        "desc": (
            "🌲 <b>Глэмпинг «Кабан»</b> (24 кв.м) — <i>Всесезонный (Зима / Лето)</i>\n"
            "Уютный дом в сердце векового леса для комфортного отдыха в любое время года. Панорамное окно с видом на лесную чащу прямо у кровати.\n\n"
            "✨ <b>Особенности и активности:</b>\n"
            "• 🏕 Мини-кухня, раскладной диван, круглогодичное проживание\n"
            "• 🍖 Зона барбекю с мангалом\n"
    ...
    "glamp_olen": {
        ...
        "desc": (
            "🌲 <b>Глэмпинг «Олень»</b> (24 кв.м) — <i>Летний (сезонный)</i>\n"
            "Атмосферный сафари-глэмпинг для романтики и единения с природой в тёплое время года. Кровать у панорамного окна с видом на лес.\n\n"
            "✨ <b>Особенности и активности:</b>\n"
            "• 🏕 Уютный шатер, мини-кухня, раскладной диван\n"
            "• 🍖 Зона барбекю с мангалом\n"
            "• ⚽️ Площадка, батут, волейбол, футбол, настольный теннис\n"
            "• 🦌 Экотропы, веломаршруты, вольеры с животными (зубры, олени)\n\n"
            "🛋 <b>Климат и удобства (без кондиционера):</b>\n"
            "• Естественная вентиляция, вентилятор, москитные сетки\n"
            "• Обогреватель на случай прохладных ночей\n"
            "• Рабочее место, утюг, гардероб, детская кроватка\n\n"
            "🍳 <b>Мини-кухня:</b>\n"
            "СВЧ, холодильник, чайник, чай/кофе, посуда и приборы.\n\n"
            "🚿 <b>Ванная:</b> санузел, душ, фен, тапочки, косметика, бассейн.\n"
            "🌿 <b>Вид:</b> на сад, двор и вековой лес.\n\n"
    ...
    "glamp_barsuk": {
        ...
        "desc": (
            "🌲 <b>Глэмпинг «Барсук»</b> (24 кв.м) — <i>Летний (сезонный)</i>\n"
            "Атмосферный сафари-глэмпинг для романтики и единения с природой в тёплое время года. Кровать у панорамного окна с видом на лес.\n\n"
            "✨ <b>Особенности и активности:</b>\n"
            "• 🏕 Уютный шатер, мини-кухня, раскладной диван\n"
            "• 🍖 Зона барбекю с мангалом\n"
