...
async def get_reviews_page():
    ...
    return {"error": "reviews.html not found"}
...
def get_houses_menu():
    """Меню выбора категории проживания (дома и глэмпинги)"""
    builder = InlineKeyboardBuilder()

    # Дома
    builder.row(InlineKeyboardButton(text="🏡 Уютный Стандарт", callback_data="house_standart"))
    builder.row(InlineKeyboardButton(text="🏡 Уютный Стандарт Плюс", callback_data="house_standart_plus"))
    builder.row(InlineKeyboardButton(text="🏡 Семейный Полулюкс", callback_data="house_semeiniy"))
    builder.row(InlineKeyboardButton(text="👑 Охотничий Люкс", callback_data="house_ohotnichiy"))
    builder.row(InlineKeyboardButton(text="⭐ Комфорт Плюс", callback_data="house_komfort"))

    # Глэмпинги
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Зубр»", callback_data="glamp_zubr"))
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Кабан»", callback_data="glamp_kaban"))
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Олень»", callback_data="glamp_olen"))
    builder.row(InlineKeyboardButton(text="⛺ Глэмпинг «Барсук»", callback_data="glamp_barsuk"))
...
@dp.callback_query(F.data.in_(["start", "back_main", "main_menu"]))
...
HOUSES_INFO = {
    "house_standart": {
        ...
        "photo": os.path.join(MEDIA_DIR, "UYuTNII_STANDART.jpg"),
        "desc": (
            "🌲 Дом «Уютный стандарт»\n\n"
            "Идеальный выбор для семейного отдыха или романтического побега (36 кв.м). Настоящий деревянный дом из оцилиндрованного бруса с панорамным видом на лес, где царит атмосфера гармонии и тепла.\n\n"
            "✨ Главная изюминка: застеклённая терраса с камином и уютными пледами для умиротворённых вечеров в любое время года.\n\n"
            "🛋 Комфорт и оснащение:\n"
            "• Камин, обогреватель, вентилятор\n"
            "• Рабочее пространство, утюг, детская кроватка\n"
            "• Светонепроницаемые шторы, москитная сетка\n"
            "• Дополнительные подушки и одеяла\n\n"
            "🍳 Кухня:\n"
            "Микроволновка, холодильник, чайник, набор для кофе/чая, посуда и удобный обеденный стол.\n\n"
            "🚿 Ванная комната:\n"
            "Собственный санузел, душ, стиральная машина, фен, тапочки, туалетно-косметические принадлежности и доступ к бассейну.\n\n"
            "📺 Техника и вид:\n"
            "• Телевизор со спутниковым ТВ, высокоскоростной Wi-Fi\n"
            "• Живописный вид на сад, лес и внутренний двор\n\n"
            "Бронируйте свой уютный отдых на природе прямо сейчас! 👇"
        )
    },
    "house_standart_plus": {
        "title": "🏡 Уютный Стандарт Плюс",
        "photo": os.path.join(MEDIA_DIR, "UYuTNII_STANDART_PLYuS.jpg"),
        "desc": (
            "🌲 Дом «Уютный стандарт плюс»\n\n"
            "Идеальный выбор для семейного отдыха или романтического побега (24 кв.м). Тёплый деревянный дом из оцилиндрованного бруса создан для тех, кто ценит гармонию с природой и комфорт.\n\n"
            "✨ Главная изюминка: уютная застеклённая терраса с потрескивающим камином и мягкими пледами для умиротворённых вечеров в любое время года.\n\n"
            "🛋 Комфорт и климат:\n"
            "• Кондиционер и система климат-контроля, обогреватель, вентилятор\n"
            "• Москитная сетка и светонепроницаемые шторы\n\n"
            "🍳 Кухня:\n"
            "Микроволновка, холодильник, чайник, набор для кофе/чая, посуда, столовые приборы и обеденный стол.\n\n"
            "🚿 Ванная комната:\n"
            "Собственный санузел, душ, стиральная машина, фен, халаты, тапочки, туалетно-косметические принадлежности и доступ к бассейну.\n\n"
            "📺 Техника и связь:\n"
            "• Телевизор с кабельным ТВ\n"
            "• Высокоскоростной Wi-Fi и проводной интернет\n\n"
            "🌿 Вид из окон: живописный пейзаж на сад и вековой лес.\n\n"
            "Бронируйте свой незабываемый отдых на природе прямо сейчас! 👇"
        )
    },
    "house_semeiniy": {
        "title": "🏡 Семейный Полулюкс",
        "photo": os.path.join(MEDIA_DIR, "SEMEINII_POLULYuKS.jpg"),
        "desc": (
            "🌲 Просторный семейный дом (54 кв.м)\n\n"
            "Идеальный выбор для отдыха большой семьей или компанией. Дом состоит из спален с ортопедическими матрацами и полным комплектом постельных принадлежностей.\n\n"
            "✨ Главные особенности:\n"
            "• 🔥 Кухня-гостиная с камином, спутниковым ТВ, свежим кофе и ассортиментом травяного чая\n"
            "• 🪵 Меблированная терраса с уютными пледиками и подушечками\n"
            "• 🍖 Готовая зона барбекю: казан, решетка, шампура, угли и ароматные дрова фруктовых пород\n\n"
            "🛋 Комфорт и оснащение:\n"
            "• Обогреватель, вентилятор, рабочее пространство, утюг, детская кроватка\n"
            "• Москитные сетки, дополнительные подушки и одеяла\n\n"
            "🍳 Современная кухня:\n"
            "Бытовая техника последнего поколения (духовка, микроволновка, холодильник, чайник), полный набор посуды и большой обеденный стол.\n\n"
            "🚿 Ванная комната:\n"
            "Собственный санузел, душ, стиральная машина, фен, тапочки, средства гигиены (полотенца, шампунь, гель для душа, мыло) и доступ к бассейну.\n\n"
            "📺 Техника и вид:\n"
            "• Телевизор со спутниковым ТВ, высокоскоростной Wi-Fi\n"
            "• Живописный вид на внутренний двор, сад и вековой лес\n\n"
            "Бронируйте свой незабываемый отдых прямо сейчас! 👇"
        )
    },
    "house_ohotnichiy": {
        "title": "👑 Охотничий Люкс",
        "photo": os.path.join(MEDIA_DIR, "OKhOTNIChII_LYuKS.jpg"),
        "desc": (
            "🌲 Охотничий Люкс\n\n"
            "Идеальное место для большой семьи или компании до 10 человек (площадь 86 кв.м). Просторный дом окружен вековым лесом — здесь царит тишина, покой и чистейший воздух.\n\n"
            "✨ Главные особенности:\n"
            "• 🛏 4 спальни с удобными спальными местами и дополнительными одеялами\n"
            "• 🔥 Гостиная с камином для атмосферных вечеров\n"
            "• 🌳 Просторная терраса и беседка с зоной барбекю\n"
            "• 🏊‍♂️ Бассейн для жарких дней\n"
            "• 🪩 Качели во дворе для отдыха на свежем воздухе\n\n"
            "🛋 Комфорт и оснащение:\n"
            "• Климат: кондиционер, система климат-контроля, обогреватель, вентилятор, москитные сетки и светонепроницаемые шторы\n"
            "• Удобства: стиральная машина, утюг, рабочее пространство, шкаф/гардероб, детская кроватка\n"
            "• Ванная: собственный санузел, душ, фен, тапочки и туалетно-косметические принадлежности\n\n"
            "🍳 Полноценная кухня:\n"
            "Холодильник, духовка, микроволновка, кофемашина/кофеварка, чайник, полный набор посуды, столовые приборы и большой обеденный стол.\n\n"
            "📺 Техника и развлечения:\n"
            "• Высокоскоростной Wi-Fi\n"
            "• Телевизор со спутниковым ТВ\n"
            "• Музыкальный проигрыватель / звуковая система\n\n"
            "🌿 Вид из окон: живописный пейзаж на внутренний двор, сад и вековой лес.\n\n"
            "📅 Отличный вариант, чтобы отдохнуть от городской суеты, насладиться природой и провести время с близкими.\n\n"
            "Бронируйте отпуск своей мечты прямо сейчас! 👇"
        )
    },
    "house_komfort": {
        "title": "⭐ Комфорт Плюс",
        "photo": os.path.join(MEDIA_DIR, "KOMFORT_PLYuS.jpg"),
        "desc": (
            "🌟 Дом «Комфорт Плюс»\n\n"
            "Роскошная резиденция для 2–4 человек (36 кв.м), идеально сочетающая современные удобства и элегантный дизайн. Ваш личный оазис спокойствия, уюта и стиля в окружении природы.\n\n"
            "✨ Главные особенности:\n"
            "• 🚪 Отдельный вход для полной приватности\n"
            "• 🪟 Панорамные окна от пола до потолка с потрясающим естественным светом\n"
            "• ☕️ Просторная терраса и балкон для утреннего кофе и вечерних посиделок\n"
            "• 🔥 Каминная зона и светлая гостиная для семейных вечеров\n\n"
            "🛋 Комфорт и оснащение:\n"
            "• Климат: кондиционер, система климат-контроля, обогреватель, вентилятор, москитные сетки и светонепроницаемые шторы\n"
            "• Удобства: рабочее пространство, утюг, шкаф, детская кроватка, дополнительные подушки и одеяла\n\n"
            "🍳 Современная кухня:\n"
            "Оснащена новейшей техникой (микроволновка, духовка, тостер, чайник, кофе/чай), полным набором посуды, столовыми приборами и обеденным столом.\n\n"
            "🚿 Ванная комната и услуги:\n"
            "• Собственный санузел, душевая кабина, стиральная машина, фен, тапочки, туалетно-косметические принадлежности и доступ к бассейну\n"
            "• Дополнительно: доступна услуга хранения багажа\n\n"
            "📺 Техника и вид:\n"
            "• Телевизор со спутниковым ТВ, высокоскоростной Wi-Fi\n"
            "• Живописный вид на внутренний двор, сад и лес\n\n"
            "Бронируйте свой идеальный отдых прямо сейчас! 👇"
        )
    },
    "glamp_zubr": {
        "title": "⛺ Глэмпинг «Зубр»",
        "photo": os.path.join(MEDIA_DIR, "GLEMPING_ZUBR.jpg"),
        "desc": (
            "🌲 Глэмпинг «Зубр»\n\n"
            "Уникальное сочетание роскошного комфорта и девственной природы в самом сердце древнего леса (24 кв.м). Эргономичный интерьер в натуральных тонах с кроватью у самого окна и панорамным видом на лесную чащу.\n\n"
            "✨ Главные особенности:\n"
            "• 🏕 Уютные палатки и коттеджи: мини-кухня, раскладной диван и естественная циркуляция воздуха\n"
            "• 🍖 Зона барбекю для самостоятельного приготовления блюд на углях\n"
            "• ⚽️ Активный отдых на территории: детская площадка, батут, волейбол, футбол и настольный теннис\n"
            "• 🦌 Увлекательные маршруты: экскурсии по лесным тропам, веломаршруты, вольеры с дикими животными (зубры, лоси, белые олени) и резиденция Деда Мороза\n\n"
            "🛋 Комфорт и оснащение:\n"
            "• Климат: кондиционер, система климат-контроля, обогреватель, вентилятор, москитные сетки\n"
            "• Удобства: рабочее пространство, утюг, шкаф/гардероб, детская кроватка, дополнительные подушки и одеяла\n\n"
            "🍳 Мини-кухня:\n"
            "Микроволновка, холодильник, чайник, набор для кофе/чая, полный набор посуды и столовые приборы.\n\n"
            "🚿 Ванная комната:\n"
            "Собственный санузел, душ, фен, тапочки, туалетно-косметические принадлежности и доступ к бассейну.\n\n"
            "🌿 Вид из окон: живописный пейзаж на внутренний двор, сад и вековой лес.\n\n"
            "Оживите свою связь с природой — бронируйте незабываемый отдых прямо сейчас! 👇"
        )
    },
    "glamp_kaban": {
        "title": "⛺ Глэмпинг «Кабан»",
        "photo": os.path.join(MEDIA_DIR, "GLEMPING_KABAN.jpg"),
        "desc": (
            "🌲 Глэмпинг «Кабан»\n\n"
            "Уникальное сочетание роскошного комфорта и девственной природы в самом сердце древнего леса (24 кв.м). Эргономичный интерьер в натуральных тонах с кроватью у самого окна и панорамным видом на лесную чащу.\n\n"
            "✨ Главные особенности:\n"
    ...
    "glamp_olen": {
        "title": "⛺ Глэмпинг «Олень»",
        "photo": os.path.join(MEDIA_DIR, "GLEMPING_OLEN.jpg"),
        "desc": (
            "🌲 Глэмпинг «Олень»\n\n"
            "Уникальное сочетание роскошного комфорта и девственной природы в самом сердце древнего леса (24 кв.м). Эргономичный интерьер в натуральных тонах с кроватью у самого окна и панорамным видом на лесную чащу.\n\n"
            "✨ Главные особенности:\n"
    ...
    "glamp_barsuk": {
        "title": "⛺ Глэмпинг «Барсук»",
        "photo": os.path.join(MEDIA_DIR, "GLEMPING_BARSUK.jpg"),
        "desc": (
            "🌲 Глэмпинг «Барсук»\n\n"
            "Уникальное сочетание роскошного комфорта и девственной природы в самом сердце древнего леса (24 кв.м). Эргономичный интерьер в натуральных тонах с кроватью у самого окна и панорамным видом на лесную чащу.\n\n"
            "✨ Главные особенности:\n"
...
@dp.callback_query(F.data == "houses_menu")
async def process_houses_menu(callback: types.CallbackQuery):
    text = "🌲 <b>Выберите категорию проживания в усадьбе «Магия Леса»:</b>"
    try:
        await callback.message.delete()
    except Exception:
        pass
    await callback.message.answer(text, reply_markup=get_houses_menu(), parse_mode="HTML")
    await callback.answer()
...
async def show_house_details(callback: types.CallbackQuery):
    ...
    text = (
        f"<b>{data['title']}</b>\n\n"
        f"{data['desc']}\n\n"
        "Нажмите кнопку ниже, чтобы проверить свободные даты и забронировать:"
    )
    ...
    try:
        ...
        logging.error(f"Ошибка при отправке карточки дома: {e}")
        await callback.message.answer(
            text=text,
            reply_markup=builder.as_markup(),
            parse_mode="HTML"
