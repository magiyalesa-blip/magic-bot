...
HOUSES_INFO = {
    ...
    "glamp_zubr": {
        ...
        "desc": (
            "🌲 <b>Глэмпинг «Зубр»</b> (24 кв.м)\n"
            "Роскошный комфорт в сердце древнего леса. Кровать у панорамного окна с видом на лесную чащу.\n\n"
            "✨ <b>Особенности и активности:</b>\n"
            "• 🏕 Мини-кухня, раскладной диван, естественная вентиляция\n"
            ...
            "🛋 <b>Удобства и климат:</b>\n"
            "• Кондиционер, климат-контроль, обогреватель, москитные сетки\n"
